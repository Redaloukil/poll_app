...
)  # (server/config/settings/base.py - 3 = server/)
...
DATABASES = {
    "default": env.db("DATABASE_URL", default="postgres:///server")
}
...
LOCAL_APPS = [
    ...
    "server.generics.apps.GenericsAppConfig",
    "server.polls.apps.PollsAppConfig",
]
