...
const restApiControllers = require('./api/user'); 
const userRestApiControllers = require('./api/user');
const authRestApiControllers = require('./api/auth');
const pollRestApiControllers = require('./api/poll');
...
app.get('services/api/' , restApiControllers);
app.get('services/api/users' , userRestApiControllers.getUsers);
app.post('services/api/users' , userRestApiControllers.postUsers);
app.get('services/api/auth/login' , authRestApiControllers.loginApi);
app.get('services/api/auth/singup' , userRestApiControllers.signupApi);
/**
 * Error Handler.
 */
